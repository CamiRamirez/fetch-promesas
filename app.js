window.onload = () => {
  ...
  document.getElementById("buttonDoge").addEventListener("click", () => {
    obtenerDoges();
  });
  document.getElementById("buttonCate").addEventListener("click", () => {
    obtenerGatos();
  });


  // La funcion normal, puede ser llamada desde cualquier parte. La arrow function no.
